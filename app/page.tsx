      ...
      <section className="flex flex-col w-full">
        {
          products.map((product) => (
            <Products key={product.id} id= {product.id} variant= {product.variant as "amber" | "porter" | "seltzer"} name={product.name} bitterness={product.bitterness } carbonation={product.carbonation} alcohol={product.alcohol} thumb={product.thumb} description={product.description} icons={product.icons} pattern={product.pattern}/>
          ))
        }
      </section>
